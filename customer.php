...
<head>
    ...
    <title>Customer Messages - FALCONS MOVIES</title>
...
<div class="container">
    <header class="dashboard-header">
        <div>
            ...
            <p class="header-copy">Read customer enquiries, contact details, and remove messages after they are handled.</p>
        </div>
                ...
                <table>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a class="delete-btn" href="customer.php?delete_id=<?= intval($row["id"]) ?>" onclick="return confirm('Are you sure you want to delete this message?');">Delete</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                    </tbody>
