<?php
/**
 * FALCONS Theater - central application configuration.
 *
 * Keep secrets out of this file when deploying. Use environment variables or
 * a local, untracked configuration file for SMTP/Razorpay/Google credentials.
 */
...
class AppConfig
{
    ...
    // Never expose OTPs to users/logs when mail delivery fails.
    // If local development needs a fallback, enable it only in a private local config.
    const ENABLE_OTP_FALLBACK = false;
